...
export const Hero: React.FC<HeroProps> = ({ onStartAssessment, onExploreHowItWorks }) => {
  ...
  return (
    <section id="hero-section" className="relative overflow-hidden pt-8 pb-16 lg:pt-14 lg:pb-24">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-96 bg-gradient-to-b from-rose-50/70 to-transparent pointer-events-none -z-10" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            {/* Mission Badge */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-rose-50 border border-rose-200 text-rose-800 text-xs font-semibold shadow-xs">
            ...
            <div className="pt-2 flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 font-semibold text-base transition-all shadow-xs"
              >
          ...
          <div className="lg:col-span-5">
            <div className="bg-white rounded-2xl border border-slate-200/80 shadow-xl shadow-slate-200/50 p-6 space-y-5">
              <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                <div className="flex items-center gap-2">
                  <div className="w-2.5 h-2.5 rounded-full bg-emerald-500 animate-ping" />
                  <span className="text-xs font-bold text-slate-800 uppercase tracking-wider">Interactive Live Demo</span>
                </div>
              ...
              {activeDemo === 'safe' ? (
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-emerald-50/80 rounded-xl border border-emerald-100">
                    <div>
                      <span className="text-xs font-bold text-emerald-800 uppercase tracking-wide">Estimated Risk</span>
                      <div className="flex items-baseline gap-2">
                        <span className="text-3xl font-black text-emerald-700">18</span>
                    ...
                    <div className="w-12 h-12 rounded-full border-4 border-emerald-500/20 border-t-emerald-600 flex items-center justify-center font-bold text-emerald-700 text-xs">
                      94% Conf.
                    </div>
                  </div>

                  <div className="space-y-2 text-xs">
                    <p className="font-semibold text-slate-700">Identified Safety Buffers:</p>
                    <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg text-slate-600">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-rose-50/80 rounded-xl border border-rose-100">
                    <div>
                      <span className="text-xs font-bold text-rose-800 uppercase tracking-wide">Estimated Risk</span>
                      <div className="flex items-baseline gap-2">
                        <span className="text-3xl font-black text-rose-700">82</span>
                        <span className="text-sm font-medium text-rose-600">/ 100</span>
                        <span className="ml-2 px-2 py-0.5 bg-rose-600 text-white rounded-full text-xs font-bold">
                          High Risk
                        </span>
                      </div>
                    </div>
                    <div className="w-12 h-12 rounded-full border-4 border-rose-500/20 border-t-rose-600 flex items-center justify-center font-bold text-rose-700 text-xs">
                      94% Conf.
                    </div>
                  </div>

                  <div className="space-y-2 text-xs">
                    <p className="font-semibold text-slate-700">Contributing Risk Amplifiers:</p>
                    <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-lg text-slate-600">
              ...
              <div className="pt-2 border-t border-slate-100">
                <button
                  type="button"
                  onClick={onStartAssessment}
                  className="w-full py-2.5 text-center text-xs font-bold text-rose-600 hover:text-rose-700 hover:bg-rose-50 rounded-lg transition-colors"
                >
